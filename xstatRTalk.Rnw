...
\href{https://github.com/jharner/UseR2019xstatR}{GitHub repo for this talk: UseR2019xstatR}\\
\vspace{0.25cm}
...
\vspace{1cm}
\begin{center}
\href{https://stat.wvu.edu/~jharner/useR2019/xstatRvideos.html}{XLisp-Stat and xstatR Demos}
\end{center}
\end{frame}
