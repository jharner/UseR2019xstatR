...
\begin{itemize}
	...
	\item a strong way of symbolic AI programming 
\end{itemize}
and much more!
\end{frame}
...
\begin{description}
	\item[xstatR] for embedding R into XLisp-Stat using R as a dynamic library
	\item[RXLisp] for embedding XLisp-Stat into R using XLisp-Stat as a dynamic library
\end{description}
\vspace{0.25 cm}
...
\href{https://github.com/jharner/xstatR}{xstatR GitHub repo}\\
\vspace{0.25cm}
...
\href{https://github.com/jharner/RXLisp}{RXLisp GitHub repo}\\
\vspace{0.25cm}
...
\begin{itemize}
	...
	\item Virtual model datasets combined with a model tree recursively allow model
	comparisons 
\end{itemize}
\end{frame}
